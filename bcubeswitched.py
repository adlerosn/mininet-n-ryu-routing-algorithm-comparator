...
def _init(topo):
    ...
    info('*** Adding links\n')
    topo.addLink(s6, h1, 1, 1, cls=TCLink, bw=1)
    topo.addLink(s7, h2, 2, 2, cls=TCLink, bw=1)
    topo.addLink(s8, h3, 3, 3, cls=TCLink, bw=1)
    topo.addLink(s9, h4, 4, 4, cls=TCLink, bw=1)
    topo.addLink(s5, s6, 5, 5, cls=TCLink, bw=1)
    topo.addLink(s5, s7, 6, 6, cls=TCLink, bw=1)
    topo.addLink(s5, s8, 7, 7, cls=TCLink, bw=1)
    topo.addLink(s5, s9, 8, 8, cls=TCLink, bw=1)
    topo.addLink(s11, h5, 9, 9, cls=TCLink, bw=1)
    topo.addLink(s12, h6, 10, 10, cls=TCLink, bw=1)
    topo.addLink(s13, h7, 11, 11, cls=TCLink, bw=1)
    topo.addLink(s14, h8, 12, 12, cls=TCLink, bw=1)
    topo.addLink(s10, s11, 13, 13, cls=TCLink, bw=1)
    topo.addLink(s10, s12, 14, 14, cls=TCLink, bw=1)
    topo.addLink(s10, s13, 15, 15, cls=TCLink, bw=1)
    topo.addLink(s10, s14, 16, 16, cls=TCLink, bw=1)
    topo.addLink(s16, h9, 17, 17, cls=TCLink, bw=1)
    topo.addLink(s17, h10, 18, 18, cls=TCLink, bw=1)
    topo.addLink(s18, h11, 19, 19, cls=TCLink, bw=1)
    topo.addLink(s19, h12, 20, 20, cls=TCLink, bw=1)
    topo.addLink(s15, s16, 21, 21, cls=TCLink, bw=1)
    topo.addLink(s15, s17, 22, 22, cls=TCLink, bw=1)
    topo.addLink(s15, s18, 23, 23, cls=TCLink, bw=1)
    topo.addLink(s15, s19, 24, 24, cls=TCLink, bw=1)
    topo.addLink(s21, h13, 25, 25, cls=TCLink, bw=1)
    topo.addLink(s22, h14, 26, 26, cls=TCLink, bw=1)
    topo.addLink(s23, h15, 27, 27, cls=TCLink, bw=1)
    topo.addLink(s24, h16, 28, 28, cls=TCLink, bw=1)
    topo.addLink(s20, s21, 29, 29, cls=TCLink, bw=1)
    topo.addLink(s20, s22, 30, 30, cls=TCLink, bw=1)
    topo.addLink(s20, s23, 31, 31, cls=TCLink, bw=1)
    topo.addLink(s20, s24, 32, 32, cls=TCLink, bw=1)
    topo.addLink(s1, s6, 33, 33, cls=TCLink, bw=1)
    topo.addLink(s2, s7, 34, 34, cls=TCLink, bw=1)
    topo.addLink(s3, s8, 35, 35, cls=TCLink, bw=1)
    topo.addLink(s4, s9, 36, 36, cls=TCLink, bw=1)
    topo.addLink(s1, s11, 37, 37, cls=TCLink, bw=1)
    topo.addLink(s2, s12, 38, 38, cls=TCLink, bw=1)
    topo.addLink(s3, s13, 39, 39, cls=TCLink, bw=1)
    topo.addLink(s4, s14, 40, 40, cls=TCLink, bw=1)
    topo.addLink(s1, s16, 41, 41, cls=TCLink, bw=1)
    topo.addLink(s2, s17, 42, 42, cls=TCLink, bw=1)
    topo.addLink(s3, s18, 43, 43, cls=TCLink, bw=1)
    topo.addLink(s4, s19, 44, 44, cls=TCLink, bw=1)
    topo.addLink(s1, s21, 45, 45, cls=TCLink, bw=1)
    topo.addLink(s2, s22, 46, 46, cls=TCLink, bw=1)
    topo.addLink(s3, s23, 47, 47, cls=TCLink, bw=1)
    topo.addLink(s4, s24, 48, 48, cls=TCLink, bw=1)

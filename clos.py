...
def _init(topo):
    ...
    topo.addLink(s2, h3, 3, 3, cls=TCLink, bw=1)
    topo.addLink(s2, h4, 4, 4, cls=TCLink, bw=1)
    topo.addLink(s3, h5, 5, 5, cls=TCLink, bw=1)
    topo.addLink(s3, h6, 6, 6, cls=TCLink, bw=1)
    topo.addLink(s4, h7, 7, 7, cls=TCLink, bw=1)
    topo.addLink(s4, h8, 8, 8, cls=TCLink, bw=1)
    topo.addLink(s5, h9, 9, 9, cls=TCLink, bw=1)
    topo.addLink(s5, h10, 10, 10, cls=TCLink, bw=1)
    topo.addLink(s6, h11, 11, 11, cls=TCLink, bw=1)
    topo.addLink(s6, h12, 12, 12, cls=TCLink, bw=1)
    topo.addLink(s7, h13, 13, 13, cls=TCLink, bw=1)
    topo.addLink(s7, h14, 14, 14, cls=TCLink, bw=1)
